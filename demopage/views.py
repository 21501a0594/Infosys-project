...
def contact(request):
    if request.method == 'POST':
        ...
        # Handle the form submission logic (e.g., send email, save to database)
        ...
        try:
            ...
            if isinstance(abo_image, InMemoryUploadedFile):
                ...
                if cv_image is not None:
                    ...
                    # Divide the image into 3 equal vertical regions
                    ...
                    # Aggregate results from regions
